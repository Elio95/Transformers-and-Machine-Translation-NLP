# -*- coding: utf-8 -*-
"""BERT on Tweets in Portuguese.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/14rVDZB-hFWksB051qW4T_ACFLH15WcT8
"""
...
def load_data():
    no_theme = pd.read_csv('/content/NoThemeTweets.csv',index_col=0)
    # the `type` column will be important in the future to stratify the splits
    no_theme['type'] = 'no_theme-'

    with_theme = pd.read_csv('/content/TweetsWithTheme.csv', index_col=0)
...
for epoch in epoch_bar:
    ...
    for idx, inputs in batch_bar:
        ...
        scheduler.step()
    os.makedirs('/content0/working/checkpoints/epoch'+str(epoch))
    model.save_pretrained('/content0/working/checkpoints/epoch'+str(epoch))
