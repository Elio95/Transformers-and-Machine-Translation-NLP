# -*- coding: utf-8 -*-
"""albert on chnsenticorp

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1n9ASaLaqk9zRlBc9je43EAQvqAZsHyh8
...
"""### Download an ALBERT Chinese model from HF Community Models"""
...
model = ClassificationModel(
    "bert", "voidful/albert_chinese_small",
...
save_model('outputs','chinese-albert-tiny')
...
unpack_model('chinese-albert-tiny')
...
result, model_outputs, wrong_predictions =model.eval_model(dataset.get_test_df())
accuracy = (result['tp'] + result['tn'])/dataset.test_num
print(accuracy)